...
app.layout = html.Div([
    ...
    html.Div(id='output-container', className='chart-grid', style={style='display': 'flex'}),
])
...
def update_input_container(enabled):
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        # use groupby to create relevant data for plotting
        average_sales = Yearly Statistics.groupby('vehicle_type')('price').mean().reset_index()                           
        R_chart2  = dcc.Graph(
            figure=px.line(yeearly_rec,
            x='vehicle_type'
            y='price',
